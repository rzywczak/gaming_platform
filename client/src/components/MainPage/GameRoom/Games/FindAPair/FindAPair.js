...
function FindAPair(props) {
  ...
  return (
    <>
      ...
      {props.isGameBoardHidden ? <div className="try-again">{props.resultGame.message} <button className="try-again__button" onClick={() => props.playAgain()}>Zagraj poownie</button> </div> :
